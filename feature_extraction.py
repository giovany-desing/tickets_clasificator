...
class FeatureExtraction:
    ...
    def assign_topics(self):
        ...
        for topic_idx, topic in enumerate(self.H):
            ...
            if "davibox" in top_words or "carg" in top_words or "legaliz" in top_words:
                topic_name = "Documentos Davibox"
            elif "corre" in top_words or "reenvi" in top_words or "encarg" in top_words or "nic" in top_words:
